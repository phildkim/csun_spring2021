...
\begin{center}
  ...
  \fbox{\begin{minipage}{53em}
    \begin{enumerate}
      ...
      \item[-] My hypothesis on the effect of C. elegans on each drug would be similar effect it has on humans since we\\share a common ancestor with C. elegans. So for ethanol would probably have a negative effect and\\caffeine having a positive effect with both significant differences.
