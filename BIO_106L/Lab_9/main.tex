...
\begin{center}
  ...
  \begin{center}
    ...
    \begin{align*}
      ...
      &=\boxed{3.45}\\
      \mathcal{CI}_{\DB{B}}&= 2\cdot \epsilon_{\DB{B}}\\
      &=\boxed{6.90~(95\%~\mathcal{CI}_{\DB{B}})}\\
      Upper~\mathcal{CL}_{\DB{B}}&=\overline{\DB{B}} +\left(2\cdot \epsilon_{\DB{B}}\right)\\
      &=\boxed{18.83}\\
      Lower~\mathcal{CL}_{\DB{B}}&=\overline{\DB{B}} -\left(2\cdot \epsilon_{\DB{B}}\right)\\
      &=\boxed{5.12}\\
    \end{align*}
  \end{center}
