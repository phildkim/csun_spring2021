...
/**
 * The FIFO (First-In-First-Out) algorithm schedules processes strictly according to the process arrival time.
 **/
void fifo() {
...
/**
 * The SJF (Shortest Job First) algorithm schedules processes according to the total CPU time requirements.
 **/
void sjf() {
...
/**
 * The SRT (Shortest Remaining Time) algorithm schedules processes according to the remaining CPU time needed to complete the work.
 **/
void srt() {
  int i, t, n, r = 0, min, turnaround_total = 0;
  printf("Enter the number of process: ");
